/**
 * 名称：Endless_Google.js
 * 地址：https://openuserjs.org/install/tumpio/Endless_Google.user.js
 *
 ******** 以下为 tamperJS 自动生成的 rewrite 相关信息，可能需要根据情况适当调整 ********

[rewrite]
http:\/\/www\.google\..* url script-response-body Endless_Google.js
https:\/\/www\.google\..* url script-response-body Endless_Google.js
https:\/\/encrypted\.google\..* url script-response-body Endless_Google.js
...
document.addEventListener("DOMContentLoaded", init);
  ...
  console.log('添加 tamperJS：Endless_Google.js')
}
